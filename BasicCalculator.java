...
public class BasicCalculator extends JFrame implements ActionListener{
	...
	private void initialize(){
		...
		text = new JTextField();
		text.setSize(new Dimension(170, 40));
		...
		panel.setLocation(new Point(20, 90));
		...
		clearBtn.setLocation(new Point(194, 23));
		clearBtn.setBackground(Color.red);
		
		functionBtn = new JButton[7];
		...
		functionBtn[5] = decBtn;
		functionBtn[6] = clearBtn;
		
		functionBtn[0].setBackground(Color.ORANGE);
		functionBtn[1].setBackground(Color.ORANGE);
		functionBtn[2].setBackground(Color.ORANGE);
		functionBtn[3].setBackground(Color.ORANGE);
		functionBtn[4].setBackground(new Color(0, 128, 0));
		...
		for(int i = 0; i < 7; i++){
			...
			functionBtn[i].setSize(new Dimension(75, 30));
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource() == functionBtn[5]){ // decimal function 
